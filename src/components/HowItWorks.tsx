...
export default function HowItWorks() {
  return (
    <section className="relative py-24 overflow-hidden bg-gradient-to-br from-slate-50 via-sky-100 to-white text-slate-950">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <span className="inline-block rounded-full bg-sky-100 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-sky-700">Our Process</span>
            ...
            {steps.map((step, i) => {
              ...
              return (
                <motion.div key={step.num} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
                  ...
                  <div className="relative mx-auto mb-6 mt-6 h-24 w-24 rounded-[28px] bg-gradient-to-br from-sky-500 to-cyan-400 p-1 shadow-xl">
                  ...
                  <div className="absolute -top-3 left-3 flex items-center gap-2 rounded-full bg-cyan-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-slate-900 shadow-sm">
                    <span>{step.num}</span>
                  </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          className="mt-20 rounded-3xl bg-gradient-to-br from-sky-600 via-cyan-500 to-sky-500 p-10 lg:p-14 text-center relative overflow-hidden text-white shadow-2xl shadow-sky-200/30">
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link to="/contact" className="rounded-xl bg-white px-8 py-4 text-sm font-bold text-slate-900 shadow-xl shadow-slate-300/30 hover:bg-slate-100 transition-all hover:scale-105">
                Request Free Demo
              </Link>
