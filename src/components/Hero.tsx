...
export default function Hero() {
  ...
  // Parallax for the background logo — moves slower than content
  const logoBgY = useTransform(scrollYProgress, [0, 1], [0, 60]);
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(37,99,235,0.15) 0%, rgba(250,204,21,0.08) 50%, transparent 70%)",
          }}
        />

        {/* The logo itself — large, faded, slightly blurred */}
        <motion.img
          src={logoUrl}
          alt=""
          aria-hidden="true"
          ...
          className="w-[520px] sm:w-[640px] lg:w-[760px] max-w-[80vw] object-contain"
          style={{
            opacity: 0.07,
      ...
      {/* Second ghost logo — offset, rotated, adds depth */}
      <motion.div
      ...
      >
        <motion.img
          ...
          className="absolute -bottom-16 -right-24 w-[380px] sm:w-[480px] object-contain"
          style={{
            opacity: 0.04,
